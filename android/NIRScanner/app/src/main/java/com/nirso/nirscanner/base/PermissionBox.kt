 ...
 */
package com.nirso.nirscanner.base
...
fun PermissionBox(
    ...
    val permissionState = rememberMultiplePermissionsState(permissions = permissions) { map ->
        ...
        errorText = if (rejectedPermissions.none { it in requiredPermissions }) {
            ...
            "${rejectedPermissions.joinToString()} required for the application"
        }
    }
...
private fun PermissionScreen(
    ...
    Column(
        ...
        Text(
            text = stringResource(id = R.string.app_name) + " requires permission(s):",
    ...
    if (showRationale) {
        AlertDialog(
            ...
            text = {
                Text(text = "Enable the following permissions:\n $permissions")
            },
            confirmButton = {
                TextButton(
                    onClick = {
